...
async function runEmulator() {
    ...
    const emulatorCommand = `emulator -gpu swiftshader_indirect -no-window -feature GLESDynamicVersion -avd android${version} -memory 3072 -partition-size 2048 -cache-size 2048 -wipe-data >/dev/null 2>&1 &`
