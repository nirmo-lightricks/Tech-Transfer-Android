...
def send_push_messages(push_message_configuration: PushMessageConfiguration) -> None:
    ...
    data_dict = {'data':push_message.to_json()}
...
def _run_program() -> None:
    ...
    print(args)
    push_message_configuration = PushMessageConfiguration(name=args.name,
                                 language_file=args.language_file, token_file=args.token_file,
